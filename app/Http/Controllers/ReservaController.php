     ...
     public function store(Request $request)
     {
         ...
         if ($request->espacio_id !== 'Otro') {
            $espacio = Espacio::find($request->espacio_id);
             ...
             // Corregido: Guarda el nombre del espacio "Otro" en espacio_nombre
             $reserva->espacio_nombre = $request->otro_espacio;
             // Puedes dejar esta línea si tienes otro propósito para otro_espacio,
             // pero para mostrar el nombre en el tooltip, espacio_nombre es suficiente.
             //$reserva->otro_espacio = $request->otro_espacio;
         }
